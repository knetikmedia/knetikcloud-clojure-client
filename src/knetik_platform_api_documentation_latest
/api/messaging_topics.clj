...
(defn get-topic-subscribers-with-http-info
  "Get all subscribers to a topic
  <b>Permissions Needed:</b> TOPICS_ADMIN"
  [id ]
  (call-api "/messaging/topics/{id}/subscribers" :get
            {:path-params   {"id" id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn get-topic-subscribers
  "Get all subscribers to a topic
  <b>Permissions Needed:</b> TOPICS_ADMIN"
  [id ]
  (:data (get-topic-subscribers-with-http-info id)))
